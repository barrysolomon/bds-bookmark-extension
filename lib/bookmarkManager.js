    ...
    addBookmarkToTable(bookmark) {
        ...
        Array.from(searchParams).forEach(param => {
            ...
            parameterValues.forEach(value => {
                ...
                deleteButton.style = 'margin-left: 5px; background-color: red; color: white; border: none; border-radius: 2px; cursor: pointer; margin:2px; padding-left:5px;  padding-top:2px';
                ...
                optionsDiv.style = 'overflow: scrolled;'; // Added padding to optionsDiv
