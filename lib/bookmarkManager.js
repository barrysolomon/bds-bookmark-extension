...
class BookmarkManager {
    ...
    addBookmarkToTable(bookmark) {
        ...
        var icon_src = iconGet(bookmark);
        editableLink.innerHTML = icon_src + bookmark.shortName;
        ...
        Array.from(searchParams).forEach(param => {
            ...
            parameterValues.forEach(value => {
                ...
                switch (param[0]) {
                    ...
                    case "timespan":
                        optionTag.title = param[0]; // Show only the parameter name
                        optionTag.textContent = value.replace("CUSTOM-", ""); // Use the parameter value as a tooltip
                        break;
                    case "lumigoTags":
                    default:
                ...
                optionTag.style = 'background-color: #ddd; border-radius: 3px; border: 1px solid #000; white-space: nowrap; margin:2px; padding:2px;'; // Added padding

                // Add a delete button to the option tag
                var deleteButton = document.createElement('button');
                deleteButton.textContent = 'X';
                deleteButton.style = 'background-color: red; color: white; height: 20px; border: 0px solid #000; border-radius: 2px; cursor: pointer; margin: 2px 0px 0px 5px;';
                ...
                deleteButton.onclick = function () {
                    ...
                    cell2.innerHTML = '<a href="' + bookmark.url + '" target="_blank">' + iconGet(bookmark) + bookmark.description + '</a>';
                ...
                optionsDiv.style = 'margin: 2px 0px 0px 5px;'; // Added padding to optionsDiv
